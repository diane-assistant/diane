...
final class UsageViewModel {
    ...
    func loadData() async {
        ...
        do {
            async let summaryTask = client.getUsageSummary(from: selectedTimeRange.from, to: nil)
            async let recentTask = client.getUsage(from: selectedTimeRange.from, to: nil, limit: 50, service: nil, providerID: nil)
