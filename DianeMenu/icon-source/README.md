...
rsvg-convert -f pdf menubar-icon.svg -o ../DianeMenu/Resources/Assets.xcassets/MenuBarIcon.imageset/menubar-icon.pdf
```
...
```
DianeMenu/Resources/Assets.xcassets/AppIcon.appiconset/
```
