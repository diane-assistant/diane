...
Ensure general-purpose UI components are extracted from domain-specific view files into standalone files under `Components/`, accessible to both the main DianeMenu target and the ComponentCatalog target.
