# Capability: View Injection Pattern

## Purpose

Enable all ViewModel-backed SwiftUI views to accept injectable ViewModels via their initializers, supporting external configuration (e.g., for the ComponentCatalog) while preserving default behavior for production use.
