# Capability: Catalog State Management

## Purpose

Define how the ComponentCatalog manages state presets for each cataloged view, enabling rendering of views in various states (empty, loading, error, loaded) without any daemon or network dependency.
