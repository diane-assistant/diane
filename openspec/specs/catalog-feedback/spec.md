# Capability: Catalog Feedback

## Purpose

Enable users to write feedback comments from within the ComponentCatalog app and create GitHub issues directly via the `gh` CLI, with auto-generated component selectors and structured issue bodies.
