...
OUTPUT_DIR="$SCRIPT_DIR/../Diane/Resources/Assets.xcassets/AppIcon.appiconset"
MENUBAR_SVG="$SCRIPT_DIR/menubar-icon.svg"
MENUBAR_OUTPUT="$SCRIPT_DIR/../Diane/Resources/Assets.xcassets/MenuBarIcon.imageset"
