...
// MARK: - Design Tokens
//
// Centralized layout constants for the Diane app.
...
/// Cross-platform color tokens for shared components.
/// macOS uses NSColor system colors; iOS uses UIColor system colors.
enum Colors {
    /// Background for control surfaces: cards, editor rows, sections.
    ...
    /// Background for text content areas: code blocks, text fields.
